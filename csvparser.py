...
def read_from_csv(filename_queue):
	...
	feature = tf.pack([RAW_NAME1, RAW_NAME2, RAW_NAME3, RAW_ADDRESS1, RAW_ADDRESS2, RAW_STATE, RAW_CITY, RAW_ZIPCODE])
	label = tf.pack([TARGET_LOC_ID])	#return a bytes object containing the values, packed according to the format string fmt.
	return feature, label

#input_pipeline https://www.tensorflow.org/versions/r1.3/api_docs/python/tf/train/shuffle_batch for more info
def input_pipe(batch_size, num_epochs = None):
	...
	capacity = 50000 					#tensorflow example default number
